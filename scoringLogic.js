...
// async function fetchMentions(keyword, socialMedia) {
//     try {
//       const allPosts = [];
      
      
//       if (socialMedia.linkedin_username) {
//         const linkedinOptions = {
//           method: 'GET',
//           url: 'https://linkedin-data-api.p.rapidapi.com/get-profile-posts',
//           params: { username: socialMedia.linkedin_username },
//           headers: {
//             'x-rapidapi-key': '39344189b5msh21c51f47d338fabp10dcfejsn510da5694dd8',
...
//       const phraseMap = {};
//       console.log("HERE")
//    let data=await peopledatalabs.getV5PersonEnrich({
//         email,
//         name:employeeName,
//         company:companyName,
...
//       const socialMedia = {
//         linkedin_url: data?.data?.data?.linkedin_url || null,
//         linkedin_username: data?.data?.data?.linkedin_username || null,
//         twitter_url: data?.data?.data?.twitter_url || null,
//         twitter_username: data?.data?.data?.twitter_username || null,
//         facebook_url: data?.data?.data?.facebook_url || null,
//         facebook_username: data?.data?.data?.facebook_username || null
//       };
...
//         const matches = await fetchMentions(keyword.Phrase, socialMedia);
